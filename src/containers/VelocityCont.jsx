...
export default function VelocityCont() {
    return (
        <>
            <section className="flex flex-col justify-center items-center gap-y-3 bg-gradient-to-r from-[#FCF6EE] to-[#B58A4C]/10 py-15 my-20 w-screen ml-[calc(50%-50vw)] px-5 sm:px-10 md:px-18 lg:px-20 relative">
